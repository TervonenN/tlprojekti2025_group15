...
for data_point_index, D_centroid_point in enumerate(np_data):
    ...
    for R_centroid_index, R_centroid_point in enumerate(random_data):
...
clusters = np.array(clusters) #muutetaan saadut tulokset numpy arrayksi
print("jotain saatiin aikaan: ", clusters)
...
number_of_clusters = random_data.shape[0]
...
new_centroids = update_centroids(number_of_clusters, np_data, clusters)
